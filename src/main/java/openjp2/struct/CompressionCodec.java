...
public class CompressionCodec extends Structure {
    ...
    public CompressionCodec(Pointer peer) {
        super(peer);
    }

    public CompressionCodec(CodecUnion m_codec_data, PointerByReference m_codec, EventManagerPointer m_event_mgr, int is_decompressor, Callbacks.DumpCodecCallback opj_dump_codec, Callbacks.GenericCallback opj_get_codec_info, Callbacks.GenericCallback opj_get_codec_index) {
        super();
    ...
    public static class ByValue extends CompressionCodec implements Structure.ByValue { }
    ...
    public static class CodecUnion extends Union {
        ...
        public CodecUnion() {
            setType(CompressionHandler.class);
        }
