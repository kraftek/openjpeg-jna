...
public class Constants {
    ...
    public static final int OPJ_DPARAMETERS_IGNORE_PCLR_CMAP_CDEF_FLAG = 0x0001;
    public static final String JPWL_PRIVATEINDEX_NAME = "jpwl_index_privatefilename";
    public static final int OPJ_PROFILE_NONE = 0x0000;
    public static final int OPJ_PROFILE_CINEMA_4K = 0x0004;
    public static final int OPJ_J2K_STREAM_CHUNK_SIZE = 0x100000;
    public static final int JPWL_MAXIMUM_TILES = 8192;
    public static final int OPJ_PROFILE_IMF_8K_R = 0x0801;
    public static final int OPJ_J2K_MAXRLVLS = 33;
    public static final int OPJ_J2K_MH_IND = 16;
    public static final int OPJ_PROFILE_CINEMA_S2K = 0x0005;
    public static final int OPJ_J2K_DEFAULT_NB_SEGS = 10;
    public static final int OPJ_PROFILE_BC_MULTI = 0x0200;
    public static final int OPJ_PROFILE_IMF_4K_R = 0x0800;
    public static final int OPJ_J2K_TH_IND = 32;
    public static final int OPJ_EXTENSION_MCT = 0x0100;
    public static final int OPJ_J2K_TCH_INFO = 8;
    public static final int OPJ_PROFILE_IMF_8K = 0x0402;
    public static final int JPWL_MAXIMUM_EPB_ROOM = 65450;
    public static final int OPJ_PROFILE_BC_MULTI_R = 0x0300;
    ...
    public static final int OPJ_PROFILE_IMF_2K = 0x0400;
    ...
    public static final int OPJ_PROFILE_BC_SINGLE = 0x0100;
    public static final int OPJ_PROFILE_0 = 0x0001;
    public static final int OPJ_PROFILE_1 = 0x0002;
    public static final int OPJ_CINEMA_24_CS = 1302083;
    public static final int OPJ_PROFILE_CINEMA_2K = 0x0003;
    public static final int OPJ_PROFILE_CINEMA_S4K = 0x0006;
    public static final int JPWL_MAX_NO_MARKERS = 512;
    public static final int OPJ_STREAM_WRITE = 0;
    public static final int OPJ_J2K_MAXBANDS = 3 * 33 - 2;
    public static final int OPJ_PROFILE_IMF_2K_R = 0x0403;
    ...
    public static final int OPJ_PROFILE_IMF_4K = 0x0401;
    ...
    public static final int OPJ_PROFILE_CINEMA_LTS = 0x0007;
    public static final int JPWL_MAXIMUM_HAMMING = 2;
    public static final int OPJ_EXTENSION_NONE = 0x0000;
    public static final int OPJ_JP2_INFO = 128;
    public static final int OPJ_PROFILE_PART2 = 0x8000;
